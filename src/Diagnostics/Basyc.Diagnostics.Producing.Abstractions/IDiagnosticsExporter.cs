...
public interface IDiagnosticsExporter
{
	...
	public ActivityStartDisposer StartActivity(string traceId, string? parentId, string name, DateTimeOffset startTime = default)
	{
		return StartActivity(ServiceIdentity.ApplicationWideIdentity, traceId, parentId, name, startTime);
	}

	public ActivityStartDisposer StartActivity(ActivityStart parentActivityStart, string name, DateTimeOffset startTime = default)
	{
	...
	public ActivityStartDisposer StartActivity(ActivityStartDisposer parentActivityStart, string name, DateTimeOffset startTime = default)
	{
