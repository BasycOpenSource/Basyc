...
public static class ReactiveViewModelBaseReactiveCommandExtensions
{
    ...
    public static ICommand ReactiveCommand<TSource>(this BasycReactiveViewModelBase viewModel,
        Action execute,
        IObservable<TSource>? canExecuteChanged = null,
        Func<bool>? canExecute = null)
    {
        canExecute ??= () => true;
        canExecuteChanged ??= Observable.Repeat(default(TSource)!, 1); //Invoke can execute changed once
    ...
    /// <include file="docs.xml" path='Docs/ReactiveCommand/Params' />
    /// <include file="docs.xml" path='Docs/ReactiveCommand/Return' />
    public static ICommand ReactiveCommand(this BasycReactiveViewModelBase viewModel, Action execute) => ReactiveCommand<bool>(viewModel, execute, default, default);
    ...
    public static ICommand ReactiveCommand(this BasycReactiveViewModelBase viewModel, Action execute, IObservable<bool> canExecuteChanged) => ReactiveUI.ReactiveCommand
    ...
    public static ICommand ReactiveCommand<TViewModel, TVmProperty>(this TViewModel viewModel,
        Action execute,
        Expression<Func<TViewModel, TVmProperty>> sourceProperty,
    ...
    /// <include file="docs.xml" path='Docs/ReactiveCommand/Params' />
    /// <include file="docs.xml" path='Docs/ReactiveCommand/Return' />
    /// <param name="canExecuteChanged">IObservable that will together with <paramref name="canExecuteChanged"/> update <see cref="ICommand"/>'s <see cref="ICommand.CanExecuteChanged"/> </param>
    /// <param name="canExecute">delegating used to set <see cref="ICommand"/>'s <see cref="ICommand.CanExecuteChanged"/>. Called with every change from <paramref name="canExecuteChanged"/> </param>
    public static ICommand ReactiveCommand<TCommandParameter, TSource>(this BasycReactiveViewModelBase viewModel,
    ...
    /// <include file="docs.xml" path='Docs/ReactiveCommand/Params' />
    /// <include file="docs.xml" path='Docs/ReactiveCommand/Return' />
    public static ICommand ReactiveCommand<TCommandParameter>(this BasycReactiveViewModelBase viewModel, Action<TCommandParameter> execute) => ReactiveCommand<TCommandParameter, bool>(viewModel, execute, default, default);
    ...
    /// <include file="docs.xml" path='Docs/ReactiveCommand/Return' />
    /// <param name="sourceProperty">Selector of property which will update <see cref="ICommand"/>'s <see cref="ICommand.CanExecuteChanged"/> .</param>
    public static ICommand ReactiveCommand<TViewModel, TCommandParameter>(this TViewModel viewModel,
        Action<TCommandParameter> execute,
