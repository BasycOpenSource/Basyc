...
/// <summary>
/// Class containing extension methods for <see cref="BasycReactiveViewModelBase"/> for creating reactive properties.
/// </summary>
public static class ReactiveViewModelBaseReactivePropertyExtensions
{
    ...
    Func<(TSourceProperty Source, TSourceProperty2 Source2), TTargetProperty> converter,
    [CallerFilePath] string sourceFilePath = "",
    [CallerLineNumber] int sourceLineNumber = 0)
        where TViewModel : class, IBasycReactiveViewModel
    {
    ...
    private static void AssertPropertyMatchesExpressionInDebug<TSender, TProperty>(string sourceFilePath,
