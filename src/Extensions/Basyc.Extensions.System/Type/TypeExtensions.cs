...
public static class TypeExtensions
{
	...
	public static FieldInfo? GetFieldEvenNested(this Type type, string fieldName, BindingFlags flags)
	{
		return type.GetField(fieldName, flags) ?? type.BaseType.NullOr(baseType => GetFieldEvenNested(baseType, fieldName, flags));
	}
	...
	{
		return obj is null ? null : converter(obj);
	}
}
