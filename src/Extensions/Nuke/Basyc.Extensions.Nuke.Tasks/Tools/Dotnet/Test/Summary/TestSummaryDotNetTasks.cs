...
public static partial class DotNetTasks
{
    ...
    public static void BasycTestCreateSummaryConsole(
        CoverageReport coverageReport,
        double minSequenceCoverage,
    ...
    private static ProjectCoverageReport? PrintProject(
        double minSequenceCoverage,
        double minBranchCoverage,
        CoverageReport? oldCoverageReport,
        Table assemblyTable,
        ProjectCoverageReport project)
    {
    ...
    private static ClassCoverageReport? PrintClass(
        double minSequenceCoverage,
        double minBranchCoverage,
        Table assemblyTable,
        ProjectCoverageReport? oldProject,
    ...
    private static Markup GetPercetangeMarkup(double newPercentage, double? oldPercentage, double minimum)
    {
        ...
        string valueDiffText = (valueDiff > 0 ? "+" : string.Empty) + valueDiff;
