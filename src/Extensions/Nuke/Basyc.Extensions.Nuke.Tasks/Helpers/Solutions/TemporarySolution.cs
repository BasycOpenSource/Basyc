...
public readonly struct TemporarySolution : IDisposable
{
	...
	{
		var uniqueName = TemporaryFile.GetNewName("temporary.generated", "sln");
	...
	public static TemporarySolution GetAffectedAsSolution(RepositoryChangeReport gitCompareReport, string unitTestSuffix, string buildProjectName, Solution solution)
	{
