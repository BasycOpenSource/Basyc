    ...
    Target UnitTestAll => _ => _
        ...
        .Executes(async () =>
        {
            ...
            if (UnitTestSettings.PublishResults)
            {
                ...
                string newHistoryFilePath = Repository.TestsHistory.AddOrUpdateHistory(GitRepository.Branch.Value(), newCoverageReport);
            ...
            string sourceBranchToCompare = PullRequestSettings.IsPullRequest
