...
public class ObjectFromByteMessageBusClient : IObjectMessageBusClient
{
	...
	{
		return byteMessageBusClient.PublishAsync(eventType, requestContext, cancellationToken);
	}
	...
	{
		return byteMessageBusClient.SendAsync(commandType, requestContext, cancellationToken);
	}
